...
CREATE UNIQUE INDEX "events_job_id_seq_idx" ON "events" USING btree ("job_id","seq");--> statement-breakpoint
CREATE UNIQUE INDEX "files_session_id_path_idx" ON "files" USING btree ("session_id","path");